...
PLAN_INITIAL_NUM_MSGS_TO_INCLUDE: int = int(_plan_cfg.get("initial_num_msgs_to_include", 4))
PLAN_MAX_RETRIES: int = int(_plan_cfg.get("max_retries", 3))
...
SUMMARY_INITIAL_NUM_MSGS_TO_INCLUDE: int = int(_summary_cfg.get("initial_num_msgs_to_include", 4))
...
CLEANUP_INITIAL_NUM_MSGS_TO_INCLUDE: int = int(_cleanup_cfg.get("initial_num_msgs_to_include", 4))
CLEANUP_MAX_RETRIES: int = int(_cleanup_cfg.get("max_retries", 3))
